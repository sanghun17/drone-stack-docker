...
utility, run `stacks/aruco-landing-jetson/scripts/start_intrinsic_preview.sh`
...
stacks/aruco-landing-jetson/scripts/run_bench_profile.sh
```
...
stacks/aruco-landing-jetson/scripts/run_camera_body_extrinsic_recorder.sh
```
...
`flight_logs/aruco-landing/camera-body-extrinsic/`. The dedicated profile keeps
