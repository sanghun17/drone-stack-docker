...
ROOT = Path('/work/flight_logs/aruco-landing/pose-transition')
...
def main():
    ...
    if manual:
        ROOT = Path(os.environ.get('ARUCO_MANUAL_CAPTURE_DIR', '/work/flight_logs/aruco-landing/manual-flight'))
        STATE = ROOT/'active_capture.json'
    ...
    if args.command == 'start':
        ...
        if manual:
            ...
            config_root = Path('/work/stacks/aruco-landing-jetson/config')
