...
PORT = 11349
ROOT = Path('/work/stacks/aruco-landing-jetson')
...
def main():
    ...
    try:
        ...
        spawn(['roslaunch', str(ROOT/'scripts/pose_transition/manual_preview.launch')])
        import rospy
        ...
        with tempfile.TemporaryDirectory(prefix='manual-recorder-test-') as capture_root:
            ...
            capture = str(ROOT/'scripts/pose_transition/capture.py')
