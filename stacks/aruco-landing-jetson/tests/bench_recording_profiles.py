...
def main():
    ...
    out=ROOT/'flight_logs/aruco-landing/manual-flight-20260919/performance'
    ...
    try:
        ...
        profiles={
            ...
            'aruco_allowlist':yaml.safe_load((ROOT/'stacks/aruco-landing-jetson/config/flight_safety_recorder.yaml').read_text()),
        }
        results=[]
