...
- 자산 루트: `stack-assets/aruco-landing-sim-x86/`.
  과거의 `modules/simulation/airsim-landing/` 명령을 그대로 사용하지 않는다.
- UE 프로젝트: `stack-assets/aruco-landing-sim-x86/unreal/ArucoLandingBaseline/`.
...
- 기존 환경 PNG: `experiments/aruco-landing/paper/simulation_environment.png`.
...
- 캡처 구현: `stack-assets/aruco-landing-sim-x86/scripts/capture_environment_figure.py`.
