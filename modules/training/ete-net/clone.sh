...
#
# Destination is deliberately the SAME tree that modules/planner/risk-aware-deploy/clone.sh
...
#
# WHY this module needs its own clone.sh even though planner/risk-aware-deploy has one:
# ete-train stacks do NOT include planner/risk-aware-deploy (they'd drag in the whole ROS
