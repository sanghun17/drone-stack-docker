...
`experiments/aruco-landing/pose-transition/handcarried-<timestamp>.bag`.
...
The implementation is `tools/pose_transition/capture.py`.

## Replay on ML

```bash
# Copy the completed bag from Jetson, then run from the repository root:
bash stack-assets/aruco-landing-jetson/tools/pose_transition/run_sitl.sh \
  experiments/aruco-landing/pose-transition/handcarried-<timestamp>.bag \
  --output experiments/aruco-landing/pose-transition/sitl-handcarried-01
```
...
replayed in SITL. See the [conditional hand-carried results](../results/pose-transition-sitl-20260919/handcarried/README.md),
...
```bash
bash stack-assets/aruco-landing-jetson/tools/pose_transition/run_sitl.sh \
  experiments/aruco-landing/pose-transition/handcarried-20260919-120243-437248.bag \
  --output experiments/aruco-landing/pose-transition/sitl-new-run \
