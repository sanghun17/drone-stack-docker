...
def write_report(out, report):
    ...
    rows+=['', 'The square-marker model cannot correct internal grid deformation or board warping. Residuals include detection, lens calibration and nonplanarity errors.',
           ...
           '## Reproduce', '```bash',
           '/usr/bin/python3 stack-assets/aruco-landing-jetson/tools/calibrate_printed_pads.py extract --bag experiments/pad-calibration-20260920-234536/2026-09-20-23-45-36.bag --output experiments/pad-calibration-20260920-234536',
           '/usr/bin/python3 stack-assets/aruco-landing-jetson/tools/calibrate_printed_pads.py fit --output experiments/pad-calibration-20260920-234536 --max-views 120',
