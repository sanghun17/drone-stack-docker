#!/bin/bash
# Run randomized, matched AirSim trials inside the simulation container.
...
exec python3 /work/stack-assets/aruco-landing-sim-x86/scripts/run_landing_trials.py "$@"
