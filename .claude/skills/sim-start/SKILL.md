...
tmux send-keys -t risk_aware_planning:infra.2 \
  "source ~/.bashrc && source /home/ml/miniforge3/etc/profile.d/conda.sh && conda activate airsim && cd ~/drone-data/risk-aware/assets/simulation/airsim/AirSim_vanila/ros && source devel/setup.bash && roslaunch airsim_ros_pkgs airsim_node.launch" C-m
```
