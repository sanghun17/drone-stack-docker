...
```bash
bash /home/ml/drone-stack-docker/stacks/sim-x86/scripts/run_init_sim.sh
```
(equivalent: `cd /home/ml/drone-stack-docker && bash /home/ml/drone-stack-docker/stacks/sim-x86/scripts/run_init_sim.sh`)
...
| `docker exec` itself fails / no such container | `drone-stack-sim-x86` not up | `bash /home/ml/drone-stack-docker/stacks/sim-x86/scripts/run_init_sim.sh` (or `/sim-start`) first |
